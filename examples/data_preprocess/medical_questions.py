...
def extract_solution(solution_str):
    # use re to extract the string answer after ####, like xxxx #### breast cancer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='~/data/medicalqa')
    ...
    def make_map_fn(split):
        ...
        def process_fn(example, idx):
            question_raw = example.pop('Open-ended Verifiable Question')

            question = question_raw + ' ' + instruction_following

            answer_raw = example.pop('Ground-True Answer')
